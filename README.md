...
React js is a library that is part of javascript. React makes it easier for developers to change data with much simpler code.
1. Describe component state.
component state is how an object renders and behaves
1. Describe props.
props are arguments passed into react components
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
side effects are anything that affects outside the scope of a function. we can sync side effects by importing it next to react import in curly braces and then we call it in a function
